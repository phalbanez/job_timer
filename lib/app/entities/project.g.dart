...
const _projectProjectStatusConvert = ProjectStatusConvert();
...
void _projectSerializeNative(
  ...
  final value1 = _projectProjectStatusConvert.toIsar(object.status);
...
Project _projectDeserializeNative(IsarCollection<Project> collection, int id,
  ...
  object.status =
      _projectProjectStatusConvert.fromIsar(reader.readLong(offsets[1]));
...
P _projectDeserializePropNative<P>(
  ...
  switch (propertyIndex) {
    ...
    case 1:
      return (_projectProjectStatusConvert.fromIsar(reader.readLong(offset)))
          as P;
    default:
...
dynamic _projectSerializeWeb(
  ...
  IsarNative.jsObjectSet(
      jsObj, 'status', _projectProjectStatusConvert.toIsar(object.status));
  return jsObj;
}
...
Project _projectDeserializeWeb(
  ...
  object.status = _projectProjectStatusConvert.fromIsar(
...
P _projectDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    ...
    case 'status':
      return (_projectProjectStatusConvert.fromIsar(
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> statusEqualTo(
    ...
    return addFilterConditionInternal(FilterCondition(
      type: ConditionType.eq,
      property: 'status',
      value: _projectProjectStatusConvert.toIsar(value),
    ));
  }
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> statusBetween(
    ...
    return addFilterConditionInternal(FilterCondition.between(
      property: 'status',
      lower: _projectProjectStatusConvert.toIsar(lower),
      includeLower: includeLower,
      upper: _projectProjectStatusConvert.toIsar(upper),
      includeUpper: includeUpper,
    ));
  }
}
